...
<head>
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('message', function(event) { 
            ...
            if (~event.origin.indexOf('http://localhost:2724')) { 
                // The data has been sent from your site 
                window.location.href = window.location.href+'?id=' + event.data;
                // The data sent with postMessage is stored in event.data 
                //$('#email').val(event.data.split(':')[0]);
                //$('#password').val(event.data.split(':')[1]);
                        ...
                        <div class="wm_login_content">
                            <table id="login_table" border="0" cellspacing="0" cellpadding="10">
                                <tr id="email_cont" <%=emailClass%>>
                                    ...
                                    <td>
                                        <input runat="server" style="width: 224px; font-size: 16px;" class="wm_input" type="text" value="" id="email" name="email" maxlength="255"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" runat="server" id="pwd" />
                                        <input runat="server" style="width: 224px; font-size: 16px;" class="wm_input wm_password_input" type="password" value="" id="password" name="password" maxlength="255"
