...
(function ($, _, undefined) {
    ...
    var MentionsInput = function (settings) {
        ...
        function addMention(mention) {
            ...
            // remove mention.value from updatedMessageText (done by Jitendra)
            updatedMessageText = start + ' ' + end;
        ...
        function onAutoCompleteItemClick(e) {
            ...
            addMention(mention);
            scrollToInput();
            // Call signalR function to add user into ChatGroup & remove the text from textbox
            addUserIntoChatGroup(mention.id);
            return false;
        }
