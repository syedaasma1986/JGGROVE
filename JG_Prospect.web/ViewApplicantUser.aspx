<%@ Page Title="" Language="C#" MasterPageFile="~/JGApplicant.Master" AutoEventWireup="true" CodeBehind="ViewApplicantUser.aspx.cs" Inherits="JG_Prospect.ViewApplicantUser" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
        <ContentTemplate>
            ...
            <div class="right_panel">
                ...
                <ul class="appointment_tab" runat="server" visible="false">
                            ...
                            <table border="0" class="tblUserData" cellspacing="0" cellpadding="0" style="margin-left: 0;">
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <asp:DropDownList ID="ddlstatus" runat="server" AutoPostBack="true" Width="349px" Visible="false"
                                    ...
                                    <td colspan="3">
                                        ...
                                        <asp:TextBox ID="txtDateSourced" runat="server" Width="239px" TabIndex="505" Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="7">
                                        <table style="margin-left: 0px;">
                                            <tr>
                                                ...
                                                <td>&nbsp;&nbsp;Ext. <%--extension--%>
                                                    <br />
                                                    <asp:TextBox ID="txtPhoneExt" runat="server" MaxLength="8" Width="25"></asp:TextBox></td>
