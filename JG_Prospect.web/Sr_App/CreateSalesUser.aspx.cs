...
namespace JG_Prospect.Sr_App
{
    public partial class CreateSalesUser : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alsert('Your session has expired,login to contineu');window.location='../stafflogin.aspx?returnurl=" + Request.Url.PathAndQuery + "'", true);
            }
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["ID"] != null)
                {
                    ...
                    if (ds.Tables[0].Rows.Count != 0)
                    {
                        ...
                        else if (!string.IsNullOrEmpty(ds.Tables[0].Rows[0]["RejectionDate"].ToString()) && ds.Tables[0].Rows[0][6].ToString() == Convert.ToByte(JGConstant.InstallUserStatus.InterviewDate).ToString())
                        {
        ...
        protected void btncreate_Click(object sender, EventArgs e)
        {
            ...
            //if (chkboxcondition.Checked == true)
            {
                ...
                objuser.status = Convert.ToInt32(JGConstant.InstallUserStatus.Deactive).ToString();
                ...
                else
                {
                    try
                    {
                        ...
                        CommonFunction.SendHRFormFillupRequestEmail(JGConstant.EmailTypes.ReminderEmail.ToString(), objuser.email, objuser.DesignationID, objuser.fristname);
