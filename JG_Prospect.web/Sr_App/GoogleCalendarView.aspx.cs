    ...
    public partial class GoogleCalendarView : System.Web.UI.Page
    {
        ...
        protected void btnSaveOfferMade_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SendEmail(JGConstant.EmailTypes.OfferMadeEmail.ToString(), email, firstName, lastName, "Offer Made", reason, Desig, HireDate, EmpType, PayRates, 105, lstAttachments);
        ...
        protected void btnSaveInterview_Click(object sender, EventArgs e)
        {
            ...
            SendEmail(JGConstant.EmailTypes.InterviewEmail.ToString(), strEmail, strFristName, strLastName, "Interview Date Auto Email", "",
