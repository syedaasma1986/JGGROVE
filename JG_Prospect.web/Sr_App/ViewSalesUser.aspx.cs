...
namespace JG_Prospect.Sr_App
{
    public partial class ViewSalesUser : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                editUserId = Convert.ToInt32(Request.QueryString["ID"]);
            ...
            {
                string status = null;
                var user = InstallUserBLL.Instance.getuserdetails(editUserId);
                if (user != null && user.Tables[0] != null && user.Tables[0].Rows.Count > 0)
                {
                ...
                if (Request.QueryString["ID"] != null)
                {
                    ...
                    if (ds.Tables[0].Rows.Count != 0)
                    {
                        ...
                        System.Web.UI.WebControls.ListItem Currency = ddlCurrency.Items.FindByValue(ds.Tables[0].Rows[0]["CurrencyId"].ToString());
                        if (Currency != null)
                        {
        ...
        protected void btnAddNote_Click(object sender, EventArgs e)
        {
            ...
            {
                ChatBLL.Instance.AddHRChatMessage(Convert.ToInt32(Request.QueryString["ID"]), txtTouchPointLogNote.Text, null);
        ...
        protected void Yes_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool result = InstallUserBLL.Instance.UpdateInstallUser(objuser, Convert.ToInt32(Session["EmailEdiId"]), JGSession.UserId);
            ...
            //if (chkboxcondition.Checked == true)
            {
                ...
                else
                {
                    try
                    {
                        ...
                        {
                            SendEmail(JGConstant.EmailTypes.UserStatusChange.ToString(), txtemail.Text, txtfirstname.Text, txtlastname.Text, ddlstatus.SelectedValue, str_Reason);
                        }
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    bool result = InstallUserBLL.Instance.UpdateInstallUser(objuser, id, JGSession.UserId);
                    ...
                    if (ddlstatus.SelectedValue == Convert.ToByte(JGConstant.InstallUserStatus.InterviewDate).ToString()
                        ...
                        || ddlstatus.SelectedValue == Convert.ToByte(JGConstant.InstallUserStatus.Deactive).ToString())
                    {
                        SendEmail(JGConstant.EmailTypes.InterviewEmail.ToString(), txtemail.Text, txtfirstname.Text, txtlastname.Text, ddlstatus.SelectedValue, str_Reason);
                    }
                    GoogleCalendarEvent.CreateCalendar(txtemail.Text, txtaddress.Text);
                    //lblmsg.Visible = true;
                    //lblmsg.CssClass = "success";
        ...
        protected void ddlstatus_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //var loginUser
            //string note= "'Status Changed By '+@SenderName+' - <span style="color: orange; ">'+ @OldStatusText+'</span> -> <span style="color: green; ">'+@NewStatusText+'</span> Date - '+ Convert(varchar(20), @ESTTime, 101) + right(convert(varchar(32), @ESTTime,100),8) +'(EST)'";
            //ChatBLL.Instance.AddHRChatMessage(Convert.ToInt32(Request.QueryString["ID"]), note);
        ...
        protected void btnSaveOfferMade_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (EditId > 0)
                {
                    ...
                    SendEmail(JGConstant.EmailTypes.OfferMadeEmail.ToString(), email, txtfirstname.Text, txtlastname.Text, "Offer Made", reason, Desig, HireDate, EmpType, PayRates, 105, lstAttachments);
                }
                else
                {
        ...
        protected void btnSaveInterview_Click(object sender, EventArgs e)
        {
            ...
            if (EditId > 0)
            {
                ...
                SendEmail(JGConstant.EmailTypes.InterviewEmail.ToString(), email, txtfirstname.Text, txtlastname.Text, "Interview Date Auto Email", string.Empty, Desig, HireDate, EmpType, PayRates, 104);
        ...
        private void SendEmail(string EmailType, string emailId, string FName, string LName, string status, string Reason)
        {
            try
            {
                string fullname = FName + " " + LName;
        ...
        public void SendEmail(string EmailType, string emailId, string FName, string LName, string status, string Reason, string Designition, string HireDate, string EmpType, string PayRates, int htmlTempID, List<Attachment> Attachments = null)
        {
            try
            {
                string fullname = FName + " " + LName;
        ...
        private void FillControls(string status)
        {
        ...
        //private void fullTouchPointLog1(string strValueToAdd)
        //{
        //    if ((Session["ID"] != null
        //        && Session["ID"].ToString() != "")
        ...
        //            , strValueToAdd
        //            , UserGuid
        //            , (int)TouchPointSource.ViewSalesUser,null,null);
