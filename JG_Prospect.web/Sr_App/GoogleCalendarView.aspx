        ...
        <asp:UpdatePanel ID="upContent" runat="server" UpdateMode="Always">
            <ContentTemplate>
                <h2>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="chkHR" runat="server" OnCheckedChanged="chkHR_CheckedChanged" Text="HR" AutoPostBack="true" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="chkCompany" runat="server" OnCheckedChanged="chkCompany_CheckedChanged" Text="Company" AutoPostBack="true" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="chkEvents" runat="server" Text="Events" OnCheckedChanged="chkEvents_CheckedChanged" AutoPostBack="true" />
                </h2>
                        ...
                        <tr>
                            <td align="right" style="height: 15px;">
                                ...
                                <label>
                                    Email
                                    <span>
                                        <asp:Label ID="lblOfferEmail" Text="*" runat="server" ForeColor="Red"></asp:Label>
                                    </span>
                                </label>
                            </td>
                            <td>
