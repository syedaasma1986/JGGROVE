...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel8" runat="server">
        <ContentTemplate>
            ...
            <div class="right_panel">
                            ...
                            <table border="0" class="tblUserData" cellspacing="0" cellpadding="0" style="margin-left: 0;">
                                <tr>
                                    ...
                                    <td colspan="3">
                                        ...
                                        <asp:DropDownList ID="ddlstatus" runat="server" Width="349px"
                                        ...
                                        <table style="margin-left: 0px;">
                                            <tr>
                                                <td style="vertical-align: top; width: 220px; padding-right: 0px !important;">First Name<span><asp:Label ID="lblReqFName" Text="*" ForeColor="Green" runat="server"></asp:Label></span>
                                                    ...
                                                    <asp:TextBox ID="txtfirstname" Placeholder="First Name" runat="server" MaxLength="40" autocomplete="off" EnableViewState="false" AutoCompleteType="None" OnTextChanged="txtfirstname_TextChanged" Width="130px" TabIndex="503"></asp:TextBox>
                                                </td>
                                                ...
                                                <asp:DropDownList runat="server" CssClass="phone" ID="ddlPhone"></asp:DropDownList>&nbsp;
                                                            ...
                                                            <li style="margin-top: -13px;">
                                                                <asp:DropDownList runat="server" OnPreRender="PhoneTypeDropdown_PreRender" CssClass="typeDrop"
                                                                    ID="ddlPhoneType" OnSelectedIndexChanged="ddlPhoneType_SelectedIndexChanged">
                                                                </asp:DropDownList>&nbsp;
                                                ...
                                                <td>
                                                    <input type="submit" value="Save User" onclick="return QuickSaveUserWithEmailorPhone();" class="GrdBtnAdd" />
                                                </td>
                ...
                <tr>
                    <td colspan="1" style="vertical-align: top;">
                        ...
                        <asp:DropDownList Width="160px" ID="ddldesignation" AppendDataBoundItems="true" TabIndex="508" runat="server" ClientIDMode="Static" AutoPostBack="False" OnSelectedIndexChanged="ddldesignation_SelectedIndexChanged1">
                    ...
                    <td colspan="4">
                        ...
                        <asp:DropDownList ID="ddlSource" runat="server" AutoPostBack="false" Width="249px" TabIndex="510">
                        </asp:DropDownList>
                ...
                <tr>
                    <td>Employee Type                                        
                        ...
                        <br />
                        <asp:DropDownList ID="ddlEmpType" runat="server" Width="170px" AutoPostBack="false" OnSelectedIndexChanged="ddlEmpType_SelectedIndexChanged">
                            <%--TabIndex="155"--%>
                ...
                <tr>
                    ...
                    <td colspan="2" align="left">
                        <input id="btnQuickSave" type="button" class="GrdBtnAdd" value="Save" onclick="return QuickSaveInstallUser();" />
                    </td>
                </tr>
                </table>
                        </li>
            ...
            <asp:Panel ID="panel6" runat="server">
                ...
                <input id="hdnAddedByUserId" runat="server" type="hidden" />
            </asp:Panel>
    ...
    <script type="text/javascript">
        ...
        /* New Create sales section - start */

        //Get Controls client id for Quick save.
        var txtFirstName = $("#<%=txtfirstname.ClientID%>");
        var txtMiddleInitialName = $("#<%=txtMiddleInitial.ClientID%>");
        var txtLastName = $("#<%=txtlastname.ClientID%>");
        var txtEmailQs = $("#<%=txtEmailQs.ClientID%>");
        var txtPhoneQs = $("#<%=txtPhoneQs.ClientID%>");
        var txtZipHomeAdd = $("#<%=txtZipHomeAdd.ClientID%>");
        var ddlDesignation = "#<%=ddldesignation.ClientID%>";
