    ...
    public partial class screening_intermediate : System.Web.UI.Page
    {
        ...
        private void LoadUserData()
        {
            ...
            if (dsUserDetails != null && dsUserDetails.Tables.Count > 0 && dsUserDetails.Tables[0].Rows.Count > 0)
            {
                ...
                ListItem PositionAppliedFor = ddlPositionAppliedFor.Items.FindByValue(drDetails["DesignationID"].ToString());
                ...
                //}
                phone = phone.IndexOf("(") >= 0 ? phone.Substring(phone.IndexOf("(")) : phone;
                phone = phone.Replace("+", "")
                           .Replace("(", "")
                           .Replace(")", "")
                           .Replace("-", "");
        ...
        private void UpdateUserData()
        {
            ...
            if (!String.IsNullOrEmpty(returnUrl))
            {
                ScriptManager.RegisterStartupScript(upnlProfile, upnlProfile.GetType()
                                                  , "Javascript", String.Concat("javascript:alert('Profile updated successfully.');window.location.href='" + returnUrl + "';"), true);
            }
