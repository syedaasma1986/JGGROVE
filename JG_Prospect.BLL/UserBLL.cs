...
namespace JG_Prospect.BLL
{
    public class UserBLL
    {
        ...
        {
            return UserDAL.Instance.GetPhoneScripts(designationId, type, subType);
        }

        public int GetCallPosition(int callerUserId)
        {
            return UserDAL.Instance.GetCallPosition(callerUserId);
        }
        ...
        {
            return UserDAL.Instance.UpdatePhoneScript(id, type, subType, title, desc, did, scriptType);
        }
        public void SaveCallPosition(int callerUserId, int candidateUserId)
        {
            UserDAL.Instance.SaveCallPosition(callerUserId, candidateUserId);
        }

        public void UpdatePhoneScriptFAQ(int id, string title, string desc, int did)
        {
            UserDAL.Instance.UpdatePhoneScriptFAQ(id, title, desc, did);
        }
